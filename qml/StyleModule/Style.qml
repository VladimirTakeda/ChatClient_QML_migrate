...
QtObject{
    readonly property color base_color: "#FFFFFF"
    readonly property color baseFilled_color: "#27A7E7"
    // readonly property color baseFilled_color: "#2AABEE"
    readonly property color leftSidePanel_color: "#293A4C"
